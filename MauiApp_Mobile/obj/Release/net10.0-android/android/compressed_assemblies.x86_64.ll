...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [123 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12349832; uint32_t buffer_offset
	}, ; 120: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12521352; uint32_t buffer_offset
	}, ; 121: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2048512, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12543912; uint32_t buffer_offset
	} ; 122: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 14592424, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [14592424 x i8] zeroinitializer, align 16
