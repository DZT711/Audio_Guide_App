...
public sealed class AdminApiOptions
{
    ...
    public string BaseUrl { get; set; } = "https://squander-neurology-overhead.ngrok-free.dev/";
    public string BaseUrlNgrok { get; set; } = "https://squander-neurology-overhead.ngrok-free.dev/";
