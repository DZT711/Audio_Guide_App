...
| Field | Details |
|---|---|
| **Project Name** | Smart Tourism MAUI (Audio Tour Guide App) |
| **Current Branch** | `Mobile_AppPerformance` |
| **Default Branch** | `main` |
| **Document Version** | v0.1alpha (Updated 2026) |
| **Status** | 🟡 Active Development |
| **Target Version** | MVP — Android Focus |
| **Platforms** | Android (Primary) · iOS (Secondary) · Web Admin Dashboard |
...
| Stakeholder | Role |
|---|---|
| Student Team | System development & operations |
| Advisor | Requirement approval & progress review |
| Vinh Khanh Food Street Shop Owners | End Users (POI Owners) |
| Domestic & International Tourists | End Users (Tourists) |
...
- ✅ Build complete multi-language audio guide system with 3 components (Mobile · Admin Web · Backend API)
- ✅ Apply modern software architecture: MVVM, RBAC, Offline-First, Modular Monolith
- ✅ Operate system with **$0 cost** using Edge-TTS and PMTiles
- ✅ On-site field testing at Vinh Khanh Food Street (District 4, HCMC)

### 1.2 Business Goals

| Objective | KPI |
|---|---|
| Enhance tourist experience at Vinh Khanh | ≥ 30 POI with full audio in 5 languages |
| Break language barriers for intl. tourists | Support: VI · EN · ZH · JA · KO |
| Empower shop owners with content management | Self-update without intermediary |
| Operate offline-first architecture | 100% core features work offline after first sync |
| Scalable model for other food streets | Modular architecture, easy expansion |
