...
# PRD — Audio Guide App for Vinh Khanh Food Street
...
|---|---|---|---|
| **Mobile Framework** | .NET MAUI | .NET 8 / 9 | Cross-platform (Android, iOS, Windows, macOS) từ một codebase C# |
...
| **Admin Web** | Blazor Server | .NET 8 | C# fullstack, Razor Components, real-time SignalR |
| **Backend API** | ASP.NET Core Web API | .NET 8 | REST API, CORS, Middleware pipeline |
...
| **Shared Library** | C# Class Library | .NET 8 | Models, DTOs, Enums dùng chung |
...
*© 2025 — Nguyễn Sĩ Huy & Nguyễn Văn Cường — Đồ án môn học*
