...
public static class AdminPermissions
{
    ...
    public const string InboxView = "inbox:view";
    ...
    public const string LocationRequest = "location:request";
    ...
    public const string AudioRequest = "audio:request";
